...
/**
 * The neo_component_style attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class ComponentStyle extends AttributeBase {

  /**
   * Constructs a new ComponentStyle instance.
   *
   * @param string $id
  ...
  public function __construct(
    ...
    public readonly array $class_variations = [],
    public readonly array $class_values = [],
  ) {}
