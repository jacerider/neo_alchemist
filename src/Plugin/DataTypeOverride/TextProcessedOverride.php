...
namespace Drupal\neo_alchemist\Plugin\DataTypeOverride;
...
/**
 * @todo Fix upstream. Only changes: extend `StringData` instead of `TypedData`.
 */
class TextProcessedOverride extends StringData implements CacheableDependencyInterface {
