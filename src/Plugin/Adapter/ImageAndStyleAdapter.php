...
#[Adapter(
  ...
  inputs: [
    'image' => [
      ...
      'properties' => [
        'src' => [
          ...
          '$ref' => 'json-schema-definitions://neo_alchemist.module/stream-wrapper-image-uri',
        ],
        'width' => [
    ...
    'imageStyle' => ['type' => 'string', '$ref' => 'json-schema-definitions://neo_alchemist.module/config-entity-id'],
  ],
  requiredInputs: ['image'],
  output: ['type' => 'object', '$ref' => 'json-schema-definitions://neo_alchemist.module/image'],
)]
