...
#[Adapter(
  ...
  inputs: [
    'imageUri' => ['type' => 'object', '$ref' => 'json-schema-definitions://neo_alchemist.module/stream-wrapper-image-uri'],
  ],
  requiredInputs: ['image'],
  output: ['type' => 'object', '$ref' => 'json-schema-definitions://neo_alchemist.module/image-uri'],
)]
